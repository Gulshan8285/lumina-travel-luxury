...
export const LEISURE_DESTINATIONS: LeisureDestination[] = [
  ...
  // 12. GUJARAT
  {
    ...
    famousPlaces: [
      ...
      { name: "Kutch / Rann of Kutch", tagline: "The Great White Desert & Rann Utsav", image: "/blogs/white-rann-kutch.jpg", highlights: ["Full moon walk on crystalline white salt flats", "Luxury tent city stays at Dhordo", "Rogan art & Kutchi embroidery artisan villages"] },
