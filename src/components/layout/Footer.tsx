...
export default function Footer() {
  ...
  const cleanPhone = (footer.phone || company.phone || "+91 74069 94752").replace(/[^0-9+]/g, '');
  ...
  return (
    <footer className={styles.footer}>
      {/* 1. VIP Concierge Pre-Footer Strip */}
      <div className={styles.vipStripWrapper}>
        <div className={styles.container}>
          <div className={styles.vipStrip}>
            <div className={styles.vipInfo}>
              <span className={styles.vipBadge}>✦ PRIVATE CLIENT CONCIERGE</span>
              <h3 className={styles.vipTitle}>Ready to Craft Your Signature Escape?</h3>
              <p className={styles.vipDesc}>
                Connect directly with our senior holiday specialists for custom villas, private transfers, and bespoke itineraries.
              </p>
            </div>
            <div className={styles.vipActions}>
              <Link href="/enquire" className={styles.vipPrimaryBtn}>
              ...
              >
                ...
                <span>WhatsApp: +91 74069 94752</span>
              </a>
            </div>
          </div>
        </div>
